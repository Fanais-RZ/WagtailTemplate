...
SECRET_KEY = '6p+k_g!%@@g0x^wh)-citwj)v#v%cn4=yy4=-n$=k=x79_s#ro'

# Add your site's domain name(s) here.
ALLOWED_HOSTS = ['www.BuscaNoticias.io']
...
DEFAULT_FROM_EMAIL = 'BuscaNoticias. <info@BuscaNoticias.io>'

# A list of people who get error notifications.
ADMINS = [
    ('Administrator', 'admin@BuscaNoticias.io'),
]
